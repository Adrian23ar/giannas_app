...
<template>
  <div class="min-h-screen flex items-center justify-center bg-brand-blanco">
    <div class="max-w-md w-full bg-white p-8 rounded-lg shadow-lg">
      ...
      <form @submit.prevent="handleLogin">
        <div class="mb-4">
          ...
          <input type="email" v-model="email" id="email" required class="w-full p-2 border rounded-md">
        </div>
        <div class="mb-6">
          <label for="password" class="block text-gray-700">Contraseña</label>
          <input type="password" v-model="password" id="password" required class="w-full p-2 border rounded-md">
        </div>
